...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4">
  <form id="joinClassForm" method="POST" action="<?= $action ?>" novalidate>
    ...
    <div class="flex gap-2">
      <input name="class_code" id="joinCode" type="text" placeholder="Masukkan Kode Kelas" required class="flex-1 px-3 py-2 rounded bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-sm" />
