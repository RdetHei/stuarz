    ...
    <div class="max-w-7xl mx-auto p-6">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between flex-wrap gap-4">
                ...
                <div class="flex items-center gap-2" href="index.php?page=noifications">
                    <button onlick="window.locations.href='index.php?page=noifications'" class="p-2 text-gray-400 hover:text-gray-200 hover:bg-[#1f2937] rounded-lg transition-colors border border-gray-700">
