<div class="relative isolate overflow-hidden bg-gradient-to-b from-gray-900 via-gray-900 to-gray-950 px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
  <div class="absolute inset-0 -z-10 overflow-hidden">
    <svg aria-hidden="true" class="absolute top-0 left-[max(50%,25rem)] h-256 w-512 -translate-x-1/2 mask-[radial-gradient(64rem_64rem_at_top,white,transparent)] stroke-gray-800 opacity-30">
      <defs>
        <pattern id="stuarz-pattern" width="200" height="200" x="50%" y="-1" patternUnits="userSpaceOnUse">
          <path d="M100 200V.5M.5 .5H200" fill="none" />
        </pattern>
      </defs>
      <svg x="50%" y="-1" class="overflow-visible fill-gray-800/40">
        <path d="M-100.5 0h201v201h-201Z M699.5 0h201v201h-201Z M499.5 400h201v201h-201Z M-300.5 600h201v201h-201Z" stroke-width="0" />
      </svg>
      <rect width="100%" height="100%" fill="url(#stuarz-pattern)" stroke-width="0" />
    </svg>
  </div>
  <div class="mx-auto grid max-w-7xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-y-10 px-2 sm:px-6 lg:px-8">
    <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
      <div class="lg:pr-4">
        <div class="lg:max-w-lg">
          <p class="text-sm font-semibold tracking-wide text-indigo-400 uppercase">Stuarz Platform</p>
          <h1 class="mt-3 text-4xl font-bold tracking-tight text-balance text-white sm:text-5xl">Alur kerja yang lebih mudah dan terintegrasi</h1>
    ...
    <div class="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-12 lg:px-8">
      <div class="lg:pr-4">
        <div class="max-w-xl text-base/7 text-gray-300 lg:max-w-lg leading-relaxed">
          <p>
          ...
          <ul role="list" class="mt-8 space-y-6 text-gray-300">
            <li class="flex gap-x-4">
              <span class="mt-1 inline-flex h-8 w-8 items-center justify-center rounded-full bg-indigo-500/15 text-indigo-400 ring-1 ring-inset ring-indigo-400/20">
              ...
              <span class="leading-7"><strong class="font-semibold text-white">Mudah digunakan.</strong> Antarmuka yang sederhana, sehingga pengguna baru pun bisa langsung beradaptasi.</span>
            </li>
            <li class="flex gap-x-4">
              <span class="mt-1 inline-flex h-8 w-8 items-center justify-center rounded-full bg-indigo-500/15 text-indigo-400 ring-1 ring-inset ring-indigo-400/20">
                <svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-5 w-5">
              ...
              <span class="leading-7"><strong class="font-semibold text-white">Keamanan terjamin.</strong> Data tersimpan aman dengan sistem enkripsi dan backup reguler.</span>
            </li>
            <li class="flex gap-x-4">
              <span class="mt-1 inline-flex h-8 w-8 items-center justify-center rounded-full bg-indigo-500/15 text-indigo-400 ring-1 ring-inset ring-indigo-400/20">
                <svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-5 w-5">
              ...
              <span class="leading-7"><strong class="font-semibold text-white">Kolaborasi lebih baik.</strong> Saling terhubung dengan tim, siswa, atau rekan kerja tanpa hambatan.</span>
            </li>
          </ul>
          <p class="mt-8 text-gray-300 leading-7">
          ...
          <h2 class="mt-16 text-2xl font-bold tracking-tight text-white">Belajar & bekerja tanpa ribet</h2>
