...
// Filter untuk siswa dengan level 'user' saja
            ...
            <tr class="hover:bg-gray-800 transition-colors">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right">
                <div class="flex items-center justify-end gap-2">
                  ...
                  <form method="post" action="index.php?page=delete_user" class="inline" onsubmit="return confirm('Yakin ingin menghapus akun siswa ini?')">
