          ...
          <tbody class="divide-y divide-gray-700">
            ...
            <tr class="hover:bg-gray-800 transition-colors">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                ...
                } elseif ($level === 'guru' || $level === 'teacher') {
                  $badgeClass = 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20';
                  $icon = 'M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222';
                } elseif ($level === 'user' || $level === 'student') {
                ...
                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium border <?= $badgeClass ?>">
                  <?php
                    ...
                    elseif ($level === 'guru' || $level === 'teacher') $labelText = 'Teacher';
                    elseif ($level === 'user' || $level === 'student') $labelText = 'Student';
                  ?>
