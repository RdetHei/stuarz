...
<style>
  .schedule-card { transition: all 0.2s cubic-bezier(0.4, 0, 0.2, 1); }
  .schedule-card:hover { background: rgba(88, 101, 242, 0.1); border-color: rgba(88, 101, 242, 0.3); transform: translateX(4px); }
  .day-header { background: linear-gradient(135deg, rgba(88, 101, 242, 0.15), rgba(114, 137, 218, 0.15)); border-left: 3px solid #5865F2; }
  .badge-lecture { background: rgba(88, 101, 242, 0.15); color: #8ea1f7; border: 1px solid rgba(88, 101, 242, 0.3); }
  .badge-lab { background: rgba(87, 242, 135, 0.15); color: #57f287; border: 1px solid rgba(87, 242, 135, 0.3); }
  .badge-tutorial { background: rgba(254, 231, 92, 0.15); color: #fee75c; border: 1px solid rgba(254, 231, 92, 0.3); }
</style>
        ...
        <div class="schedule-card p-4 bg-[#313338] rounded-lg border border-[#3f4147] hover:border-[#5865F2]/30">
          <div class="flex items-start justify-between gap-4 flex-wrap">
            ...
            <div class="flex items-center gap-2">
              <a href="index.php?page=schedule/edit/<?= $schedule['id'] ?>" class="p-2 bg-[#5865F2]/10 hover:bg-[#5865F2]/20 border border-[#5865F2]/30 text-[#8ea1f7] rounded-lg transition-all duration-200">
              ...
              <form method="POST" action="index.php?page=schedule/delete/<?= $schedule['id'] ?>" onsubmit="return confirm('Yakin ingin menghapus jadwal ini?')" class="inline">
                <button type="submit" class="p-2 bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 text-red-400 rounded-lg transition-all duration-200">
