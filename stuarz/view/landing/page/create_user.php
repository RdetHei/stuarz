...
<div class="p-6 space-y-6 min-h-screen text-gray-100">
    <div class="p-0 rounded-2xl shadow-lg bg-transparent">
        <div class="flex items-center justify-center px-6 py-4 border border-gray-700 rounded-2xl mb-4 bg-gray-800/60">
            <h1 class="text-xl font-semibold flex items-center gap-2">Buat Akun Baru</h1>
        </div>
