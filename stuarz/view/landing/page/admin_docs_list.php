                            ...
                            <tr class="hover:bg-[#1f2937] transition">
                                ...
                                <td class="px-6 py-3">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <a href="index.php?page=dashboard-admin-docs-delete&id=<?= (int)$d['id'] ?>" onclick="return confirm('Hapus dokumen ini?')" class="px-3 py-1 bg-red-600/80 text-white text-xs rounded-md hover:bg-red-500 border border-red-500/30">Hapus</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; ?>
