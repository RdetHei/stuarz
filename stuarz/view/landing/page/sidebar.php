<div class="flex h-screen">
  ...
  <div id="sidebar"
    ...
    <nav class="flex-1 px-2 py-4 space-y-2">
      <a href="#" class="flex items-center px-4 py-2 text-sm font-medium bg-gray-800 rounded-lg">
        <span class="material-icons mr-3">home</span> Dashboard
      </a>
      <a href="#" class="flex items-center px-4 py-2 text-sm hover:bg-gray-700 rounded-lg">
        <span class="material-icons mr-3">group</span> Team
      </a>
      <a href="#" class="flex items-center px-4 py-2 text-sm hover:bg-gray-700 rounded-lg">
        <span class="material-icons mr-3">folder</span> Projects
      </a>
      <a href="#" class="flex items-center px-4 py-2 text-sm hover:bg-gray-700 rounded-lg">
        <span class="material-icons mr-3">calendar_today</span> Calendar
      </a>
      <a href="#" class="flex items-center px-4 py-2 text-sm hover:bg-gray-700 rounded-lg">
        <span class="material-icons mr-3">description</span> Documents
      </a>
      <a href="#" class="flex items-center px-4 py-2 text-sm hover:bg-gray-700 rounded-lg">
    ...
    <div class="flex items-center p-4 border-t border-gray-700">
      <img class="w-10 h-10 rounded-full" src="https://i.pravatar.cc/100?img=3" alt="User" />
      <div class="ml-3">
  ...
  <div class="flex-1 bg-gray-100 p-6">
    <!-- Tombol Menu (Mobile) -->
    <button onclick="toggleSidebar()" class="lg:hidden mb-4 bg-[#0f172a] text-white px-3 py-2 rounded">
      ☰ Menu
    </button>
