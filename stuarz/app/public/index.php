...
require_once __DIR__ . '/../app/controller/AnnouncementController.php';
...
switch ($page) {
    ...
    case 'dashboard-admin-news':
        (new DashboardAdminController())->news();
        break;
    ...
    case 'class':
        (new ClassController())->class();
        break;

    default:
        http_response_code(404);
        include __DIR__ . '/../view/landing/page/notFound.php';
}
