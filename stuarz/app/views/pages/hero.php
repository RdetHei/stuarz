...
<div class="bg-gradient-to-b from-gray-900 to-gray-950">
  <div class="mx-auto max-w-12xl py-1 sm:px-6 sm:py-8 lg:px-8">
    <div class="relative isolate overflow-hidden bg-gray-800/60 px-6 pt-16 ring-1 ring-white/10 sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
      ...
      <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
        <h2 class="text-4xl font-bold tracking-tight text-balance text-white sm:text-5xl">
        ...
        <div class="mt-10 flex items-center justify-center gap-x-4 lg:justify-start">
          <a href="index.php?page=login" class="rounded-lg bg-indigo-600/90 px-4 py-2.5 text-sm font-semibold text-white ring-1 ring-inset ring-white/10 hover:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
            Mulai Sekarang
          </a>
          <a href="#" class="text-sm/6 font-semibold text-white/90 hover:text-white">
      ...
      <div class="relative mt-16 h-80 lg:mt-8">
        <img width="1824" height="1080" src="https://tailwindcss.com/plus-assets/img/component-images/dark-project-app-screenshot.png" alt="Tampilan aplikasi Stuarz" class="absolute top-0 left-0 w-228 max-w-none rounded-xl bg-white/5 ring-1 ring-white/10 shadow-2xl" />
      </div>
    </div>
  </div>
</div>
...
<!-- Features Section -->
<div class="bg-gradient-to-b from-gray-900 to-gray-950 py-24 sm:py-32">
  <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
    <h2 class="text-center text-sm font-semibold tracking-wide text-indigo-400 uppercase">Belajar Lebih Mudah</h2>
    <p class="mx-auto mt-3 max-w-2xl text-center text-4xl font-bold tracking-tight text-balance text-white sm:text-5xl">
      ...
      <div class="relative lg:row-span-2">
        ...
        <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
          <div class="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
            ...
            <p class="mt-2 max-w-lg text-sm/6 text-gray-300 max-lg:text-center">
      ...
      <div class="relative lg:row-span-2">
        ...
        <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
          ...
          <div class="relative min-h-120 w-full grow">
            <div class="absolute top-10 right-0 bottom-0 left-10 overflow-hidden rounded-tl-xl bg-gray-900/60 outline outline-white/10 shadow-xl">
...
<div class="bg-gradient-to-b from-gray-900 to-gray-950 py-24 sm:py-32">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:text-center">
      <h2 class="text-sm font-semibold tracking-wide text-indigo-400 uppercase">Implementasi Mudah</h2>
      <p class="mt-3 text-4xl font-bold tracking-tight text-pretty text-white sm:text-5xl lg:text-balance">
