    ...
    <tbody class="bg-[#111827] divide-y divide-gray-800">
      ...
      <?php foreach ($rows as $i => $row): ?>
        ...
        <td class="px-6 py-3">
          ...
          <a href="index.php?page=delete_user&id=<?= (int)($row['id'] ?? 0) ?>" onclick="return confirm('Yakin ingin menghapus akun ini?')" class="px-3 py-1 bg-red-600/80 text-white text-xs rounded-md hover:bg-red-500 border border-red-500/30">Hapus</a>
          </div>
        </td>
        </tr>
      <?php endforeach; ?>
