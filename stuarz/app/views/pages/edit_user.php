                ...
                <div class="absolute bottom-0 left-0 right-0 px-6 pb-6 flex items-end justify-between">
                    <div class="flex items-end gap-4">
                            ...
                            <div class="p-1.5 rounded-full bg-gray-800">
                                <div class="w-32 h-32 sm:w-40 sm:h-40 rounded-full overflow-hidden bg-gray-700 ring-[6px] ring-gray-800">
                                    <img id="avatarPreview" 
                                         src="<?= htmlspecialchars($prefix . ltrim($user['avatar'], '/'), ENT_QUOTES, 'UTF-8') ?>" 
                                         alt="Avatar" 
                                         class="w-full h-full object-cover" />
                                </div>
                            </div>
                        ...
                        <div class="hidden sm:block text-white pb-2">
                            <h1 class="text-2xl lg:text-3xl font-bold"><?= htmlspecialchars($user['username'] ?? $user['name'] ?? '') ?></h1>
                            <p class="text-gray-300 mt-1"><?= htmlspecialchars($user['level'] ?? 'user') ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form action="index.php?page=update_user" method="post" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            placeholder="Ceritakan tentang diri Anda..."><?= htmlspecialchars($user['bio'] ?? '') ?></textarea>
                    </div>
