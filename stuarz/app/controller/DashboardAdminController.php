...
class DashboardAdminController
{
    ...
    public function news()
    {
        ...
        $content = '../view/landing/page/admin_news_list.php';
        include '../view/dLayout.php';
    }
    ...
    public function newsCreate()
    {
        ...
        $newsItem = null;
        $content = '../view/landing/page/news_form.php';
        include '../view/dLayout.php';
    }
    ...
    public function newsDelete()
    {
        ...
        $id = (int)($_GET['id'] ?? 0);
        if ($id > 0) {
            $stmt = mysqli_prepare($config, "DELETE FROM news WHERE id = ?");
            mysqli_stmt_bind_param($stmt, "i", $id);
            mysqli_stmt_execute($stmt);
            mysqli_stmt_close($stmt);
            $_SESSION['flash'] = 'Berita dihapus';
        }
        header('Location: index.php?page=dashboard-admin-news');
        exit;
    }
